...
function FirstHalf() {
  return (
    <>
      <section className="mx-2 pt-0 grid md:grid-cols-2">
        ...
        {/* second colum */}
        <div className="h-screen p-5 lg:block">
          <div className="relative h-[75%] ">
            <div className="ml-[50%] rounded-md mt-5 w-[40%] h-[90%]  bg-[url('https://source.unsplash.com/random')] bg-cover bg-center"></div>
            <div className="absolute ml-[20%] rounded-md bottom-[15%] h-[50%] w-[40%] bg-[url('https://source.unsplash.com/random')] bg-cover bg-center "></div>
          </div>
